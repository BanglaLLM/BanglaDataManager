...
newspaper_archive_base_url = 'http://www.prothomalony.com/news-archive/'
...
for i in range(delta.days + 1):
    ...
    while (True):
        index = index + 1
        url = newspaper_archive_base_url + '?search&sortType=date-new&start_date=' +str(date_str) + '&end_date='
        print(url)
        try:
        ...
        if page_links_length == 0:
            print("No more links in archive")
            break
        else:
