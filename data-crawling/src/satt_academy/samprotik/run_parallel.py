...
Q_ID = 1
MAX_Q = 19720
SATT_URL = f"{BASE_URL}samprotik/single-question?"
HF_DATASET_ID = "BanglaLLM/SattSamprotik"
...
def get_done_ids():
    ...
    if "404" not in errors:             errors["404"] = []
    if "qna_not_found" not in errors:   errors["qna_not_found"] = []

    ids.extend(errors['404'])
    ids.extend(errors['qna_not_found'])
